...
test(
  ...
  async () => {
    ...
    await expect(getCatKeyPath()).rejects.toThrow(/^Too many/)
  }
)
...
test(
  ...
  async () => {
    ...
    await expect(getCatKeyPath()).rejects.toThrow(/^Unable to find catkey/)
  }
)
...
test(
  ...
  async () => {
    ...
    await expect(getCatKeyPath())
      .rejects
      .toThrow('catkeys directory could not be found')
  }
)
